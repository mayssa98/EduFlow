  ...
  readonly items = computed<SidebarItem[]>(() => {
    ...
    if (role === 'ADMIN') {
      return [
        ...
        { route: '/admin/courses',   labelKey: 'NAV.COURSES',    icon: ICON_BOOK },
        { route: '/admin/approvals', labelKey: 'NAV.APPROVALS',  icon: ICON_CHECK },
        { route: '/profile',         labelKey: 'NAV.PROFILE',    icon: ICON_PROFILE },
        { route: '/settings',        labelKey: 'NAV.SETTINGS',   icon: ICON_SETTINGS },
      ];
    }
    if (role === 'ENSEIGNANT') {
      return [
    ...
    return [
      ...
      { route: '/student/grades',       labelKey: 'NAV.GRADES',       icon: ICON_CHART },
      { route: '/profile',              labelKey: 'NAV.PROFILE',      icon: ICON_PROFILE },
      { route: '/settings',             labelKey: 'NAV.SETTINGS',     icon: ICON_SETTINGS },
    ];
  });
